...
public class Main {
	public static void main(String[] args) {
		...
		// 3. Order 객체 생성
		List<Product> products = Arrays.asList(pd1, pd2); // Arrays.asList 배열을 리스트로 변환
		...
		// Order(orderId=ORD123, customer=Customer(name=이승아, email=dev!, 
		...
		// Product(name=갤럭시 s24, price=670.5, description=삼성 핸드폰)], totalPrice=1870.6)
