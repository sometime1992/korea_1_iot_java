...
// == 다중 인터페이스 구현 방법 ==
// : implememts 키워드 뒤에 여러 개의 인터페이스를 ,로 구분하여 나열
// 다중 상속시 디폴트 메서드는 반드시 재정의 해야한다.
...
public class D_Interface {
	public static void main(String[] args) {
		...
		Example2 exInterface2 = exClass;
		exInterface2.printVar2();
		exInterface2.method();
