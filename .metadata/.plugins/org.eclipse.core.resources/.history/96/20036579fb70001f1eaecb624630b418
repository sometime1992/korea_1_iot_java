...
import java.util.List; // List 컬렉션 프레임워크 - 순서 o, 중복 o
...
public class Member {
	...
	public void borrowBook(Book book) throws BookAlreadyBorrowedException {
		...
		// cf) this 키워드
		// : 인스턴스화 된 객체 (실제 데이터)
		Loan loan = new Loan(this, book, LocalDate.now()); // 대여 기록 생성 - this(Member 클래스 객체의 this)
	...
	public void returnBook(Book book) {
		...
		loans.removeIf(loan -> loan.getBook().equals(book)); // 대여 목록에서 제거 (filter와 유사, 순회하면서 완전히 제거)
